...
| 25 | View website on desktop PC using Chrome and FireFox | Main section should be split into 2 columns for search results and map spanning full window height | As expected |
